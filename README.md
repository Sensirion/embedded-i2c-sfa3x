# Sensirion I2C SFA3X embedded Library

This document explains how to set up a SFA3X sensor to run on an embedded device using the I²C interface.
...
Your sensor has 5 pins that need to be connected to your board: VDD, GND, SDA, SCL, SEL.
Use the following description to connect your SFA3X:
...
5. Run the compiled executable with `./sfa3x_i2c_example_usage`
...
5. Run the compiled executable with `./sfa3x_test_hw_i2c`.
